companionApp.factory('createDialogFactory', ["$document", "$compile", "$rootScope", "$controller", "$timeout",
        ...
        if(options.template){
          if(angular.isString(options.template)){
            // Simple string template
              return '<div class="modal-body scroll modal-body-c" >' + options.template + '</div>';
          } else {
            // jQuery/JQlite wrapped object
              return '<div class="modal-body scroll modal-body-c" >' + options.template.html() + '</div>';
          }
        } else {
          // Template url
            return '<div class="modal-body scroll modal-body-c"  ng-include="\'' + options.templateUrl + '\'"></div>'
        }
      })();
