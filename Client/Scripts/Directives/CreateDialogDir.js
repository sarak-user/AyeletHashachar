var dirCounter = 0;
companionApp.directive('createDialog', ['$document', '$compile', "$rootScope", "$controller", "$timeout", '$filter', function ($document, $compile, $rootScope, $controller, $timeout, $filter) {
    return {
        transclude: true,
