...
namespace Service.Utilisties
{
    public class Messages
    {
        ...
        public static bool SendEmailToOne(All member, Messages message, int iUserId)
        {
            if (member.nvEmail != null && member.nvEmail != "")
            {
                ...
                member.nvMobileNumber = null;
                message.nvTo = member.nvEmail;
                ...
                {
                    Log.ExceptionLog(ex.Message, "sendEmailToOne, nvEmail: " + member.nvEmail + ", iPersonId: " + member.iPersonId);
                    return false;
                }
                try
                {
